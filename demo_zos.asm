...
main:
	...
	banksel	TRISC
	bcf	TRISA4		; TRISA &= ~(1<<RA4); // allow heartbeat output
;	bcf	TRISA6		; TRISA &= ~(1<<RA6); // allow clock output
	movlw	0x7f
	movwf	TRISC
...
;FIXME;	zOS_CLC	0,.32000000/.9600,PIR1,LATA,RA4,0
